...
// ===============================
#define usuario "Chrisquillixd"
#define device_Id "christopherquilli"
#define device_credentials "0150606598"
...
// WIFI
// ===============================
const char WiFi_ssid[] = "CITYCOOM_GUADALUPANA";
const char WiFi_password[] = "0102328242Q";
...
void loop() {
  ...
  if (millis() - last_send > 2000) {
    ...
    thing.write_bucket("datosSensor", data);
